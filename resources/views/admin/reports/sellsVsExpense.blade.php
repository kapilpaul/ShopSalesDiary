...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>Sells Vs Expense Summary</h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                <li><a href="#">Sells Vs Expense Summary</a></li>
            </ol>
        </section>
        <!-- Main content -->
                    ...
                    <div class="nav-tabs-custom">
                        ...
                        <div class="tab-content">
                            <div class="years" style="overflow: hidden">
                                {!! Form::open(['url' => 'reports/sellsVsexpense', 'role' => 'form', 'method' => 'GET']) !!}
                            ...
                            <tr>
                                ...
                                @if($monthly_sales)
                                    @foreach($monthly_sales as $monthly_sale)
                                        <td class="text-right">৳ {{ $monthly_sale }}</td>
                                    @endforeach
                                @endif
                            </tr>
                            <tr>
