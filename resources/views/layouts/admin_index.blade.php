...
<head>
    ...
    <title>Mobile Garden | @yield('title')</title>
    ...
    <!-- jvectormap -->
    <link rel="stylesheet" href="{{asset('libs/bower_components/jvectormap/jquery-jvectormap.css')}}">
...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="{{ route('home') }}" class="logo">
                ...
                <span class="logo-lg"><b>Mobile</b> Garden</span>
            </a>
                ...
                <div class="navbar-custom-menu">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <img src="{{env('APP_URL')}}/img/user2-160x160.jpg" class="user-image" alt="User Image">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header">
                                    ...
                                    <p>
                                        @if(Sentinel::check())
                                        {{ Sentinel::getUser()->name }}
                                        <small>Member since {{ Sentinel::getUser()->created_at->format('F Y')
                                        }}</small>
                                        @else
                                            Alex
                                ...
                                <li class="user-footer">
                                    ...
                                    <div class="pull-right">
                                        ...
                                        {!! Form::open(['method' => 'POST', 'action' => 'LoginController@logout',
                                        'id' => 'logout-form']) !!}
    ...
    <!-- Sparkline -->
    <script src="{{asset('libs/bower_components/jquery-sparkline/dist/jquery.sparkline.min.js')}}"></script>
    <!-- jvectormap  -->
    <script src="{{asset('libs/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js')}}"></script>
    <script src="{{asset('libs/plugins/jvectormap/jquery-jvectormap-world-mill-en.js')}}"></script>
    <!-- SlimScroll -->
