                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        {!! Form::select('stock_id', $stocks_item, null, ['id'=>'product_id',
                                        'class'=>'form-control select2', 'placeholder' => 'Pick a Product...' , 'style' => 'width: 100%;']) !!}
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4">
                                <div class="box-body no-right-padding">
                                    <div class="form-group has-feedback">
                                        {!! Form::label('Quantity *') !!}
                                        {!! Form::text('quantity', 1, ['onkeyup' => "quantityWise_calculation();", 'id'=>'quantity','class'=>'form-control', 'placeholder' =>  'Product Quantity']) !!}
